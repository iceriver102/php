...
<head>
	...
	<link rel="shortcut icon" href="<?php echo base_url('html/admin'); ?>/images/favicon.html">
...
<div id="cl-wrapper" class="error-container">
	<div class="page-error">
		...
		<h2 class="description text-center">Địa chỉ truy cập không tồn tại!</h2>
		<h3 class="text-center">Bạn có muốn quay lại <a href="index-2.html">Trang chủ</a>?</h3>
	</div>
	<div class="text-center copy">&copy; 2014 <a href="#">Leo Shop</a></div>
